package com.httydcraft.authcraft.velocity.component;
...
/**
 * Velocity-specific implementation of a server component.
...
public class VelocityComponent implements ServerComponent, AdventureServerComponent {
    ...
    public VelocityComponent(Component component) {
        ...
        LOGGER.atInfo().log("Initialized VelocityComponent");
    }
    // #endregion
