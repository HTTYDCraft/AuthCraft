package com.httydcraft.authcraft.api.title;
...
/**
 * Spigot-specific implementation of a server title.
 * Extends {@link ServerTitle} to handle title and subtitle display for Spigot players.
 */
public class SpigotServerTitle extends ServerTitle {
    ...
    // #region Constructors
    /**
     * Constructs a new {@code SpigotServerTitle} with a title component.
     *
     * @param title The title component. Must not be null.
     */
    public SpigotServerTitle(ServerComponent title) {
        super();
        title(Preconditions.checkNotNull(title, "title must not be null"));
        LOGGER.atInfo().log("Initialized SpigotServerTitle with title");
    }

    /**
     * Constructs a new {@code SpigotServerTitle} with default values.
     */
    public SpigotServerTitle() {
        super();
        LOGGER.atInfo().log("Initialized SpigotServerTitle with default values");
    }
    // #endregion
     ...
     *
     * @param title The title component. Must not be null.
     * @return This {@code SpigotServerTitle} instance.
     */
    @Override
    ...
    public ServerTitle send(ServerPlayer... players) {
        ...
        for (ServerPlayer player : players) {
            ...
            Bukkit.getServer().adventure()
                    .player(player.as(SpigotServerPlayer.class).getPlayer())
                    .showTitle(createdTitle);
        }
        return this;
    }
    // #endregion
